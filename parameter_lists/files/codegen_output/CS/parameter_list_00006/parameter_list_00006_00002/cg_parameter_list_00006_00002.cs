...
namespace ACCUNAV_IMU_Setting
{
    ...
    public class Parameters_DeviceID_00006_00002 : IParameterListDevice
    {
        ...
        public Parameters_DeviceID_00006_00002()
        {
            readedOnce = false;
            ...
            downStreamsSetting = new sDownStreamSetting[2];
        ...
        public sDownStreamSetting[] DownStreamsSetting
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(4044, 0, value, typeof(sDownStreamSetting), 2))
                {
        ...
        public UInt16 StreamerEnable
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(4098, 0, value, typeof(UInt16), 1))
                {
        ...
        public UInt16 StreamerExtendedHeaderEnable
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(4099, 0, value, typeof(UInt16), 1))
                {
        ...
        public UInt16 StreamerInternalClockIntervalMs
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(4100, 0, value, typeof(UInt16), 1))
                {
        ...
        public UInt16 StreamerPrescaler
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(4101, 0, value, typeof(UInt16), 1))
                {
        ...
        public UInt16[] StreamerParameterIds
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(4102, 0, value, typeof(UInt16), 200))
                {
        ...
        public UInt16 BoardStartupDelayMs
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(4310, 0, value, typeof(UInt16), 1))
                {
        ...
        public UInt16 BoardStartupRetryQty
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(4311, 0, value, typeof(UInt16), 1))
                {
        ...
        public UInt16 BoardStartupRetryDelayMs
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(4312, 0, value, typeof(UInt16), 1))
                {
        ...
        public bool ModbusWriteAll()
        {
            ...
            _status &= MainForm.modbusExt.ModbusWrite(4098, 0, streamerEnable, typeof(UInt16), 1);
            _status &= MainForm.modbusExt.ModbusWrite(4099, 0, streamerExtendedHeaderEnable, typeof(UInt16), 1);
            _status &= MainForm.modbusExt.ModbusWrite(4100, 0, streamerInternalClockIntervalMs, typeof(UInt16), 1);
            _status &= MainForm.modbusExt.ModbusWrite(4101, 0, streamerPrescaler, typeof(UInt16), 1);
            _status &= MainForm.modbusExt.ModbusWrite(4102, 0, streamerParameterIds, typeof(UInt16), 200);
            _status &= MainForm.modbusExt.ModbusWrite(4310, 0, boardStartupDelayMs, typeof(UInt16), 1);
            _status &= MainForm.modbusExt.ModbusWrite(4311, 0, boardStartupRetryQty, typeof(UInt16), 1);
            _status &= MainForm.modbusExt.ModbusWrite(4312, 0, boardStartupRetryDelayMs, typeof(UInt16), 1);
        ...
        public void ModbusReadAll()
        {
            if (readedOnce){return;} else
            {
                ...
                streamerEnable = MainForm.modbusExt.ModbusRead(4098, 0, typeof(UInt16), 1);
                streamerExtendedHeaderEnable = MainForm.modbusExt.ModbusRead(4099, 0, typeof(UInt16), 1);
                streamerInternalClockIntervalMs = MainForm.modbusExt.ModbusRead(4100, 0, typeof(UInt16), 1);
                streamerPrescaler = MainForm.modbusExt.ModbusRead(4101, 0, typeof(UInt16), 1);
                streamerParameterIds = MainForm.modbusExt.ModbusRead(4102, 0, typeof(UInt16), 200);
                boardStartupDelayMs = MainForm.modbusExt.ModbusRead(4310, 0, typeof(UInt16), 1);
                boardStartupRetryQty = MainForm.modbusExt.ModbusRead(4311, 0, typeof(UInt16), 1);
                boardStartupRetryDelayMs = MainForm.modbusExt.ModbusRead(4312, 0, typeof(UInt16), 1);
        ...
        public enum eParameterId : ushort
        {
            ...
            DOWN_STREAM_STATISTICS_0_RECEIVED_FRAME_QTY = 2105,
            DOWN_STREAM_STATISTICS_0_SEND_FRAME_QTY = 2106,
            DOWN_STREAM_STATISTICS_0_ENQUEUED_FRAME_QTY = 2107,
            DOWN_STREAM_STATISTICS_0_ENQUEUE_FAILED_FRAME_QTY = 2108,
            DOWN_STREAM_STATISTICS_0_RECEIVED_FRAME_HANDLE_EXECUTION_TIME_US = 2109,
            DOWN_STREAM_STATISTICS_0_SEND_FRAME_HANDLE_EXECUTION_TIME_US = 2110,
            DOWN_STREAM_STATISTICS_1_RECEIVED_FRAME_QTY = 2111,
            DOWN_STREAM_STATISTICS_1_SEND_FRAME_QTY = 2112,
            DOWN_STREAM_STATISTICS_1_ENQUEUED_FRAME_QTY = 2113,
            DOWN_STREAM_STATISTICS_1_ENQUEUE_FAILED_FRAME_QTY = 2114,
            DOWN_STREAM_STATISTICS_1_RECEIVED_FRAME_HANDLE_EXECUTION_TIME_US = 2115,
            DOWN_STREAM_STATISTICS_1_SEND_FRAME_HANDLE_EXECUTION_TIME_US = 2116,
            STREAMER_ENABLE = 2117,
            STREAMER_EXTENDED_HEADER_ENABLE = 2118,
            STREAMER_INTERNAL_CLOCK_INTERVAL_MS = 2119,
            STREAMER_PRESCALER = 2120,
            STREAMER_PARAMETER_IDS_0 = 2121,
            STREAMER_PARAMETER_IDS_1 = 2122,
            STREAMER_PARAMETER_IDS_2 = 2123,
            STREAMER_PARAMETER_IDS_3 = 2124,
            STREAMER_PARAMETER_IDS_4 = 2125,
            STREAMER_PARAMETER_IDS_5 = 2126,
            STREAMER_PARAMETER_IDS_6 = 2127,
            STREAMER_PARAMETER_IDS_7 = 2128,
            STREAMER_PARAMETER_IDS_8 = 2129,
            STREAMER_PARAMETER_IDS_9 = 2130,
            STREAMER_PARAMETER_IDS_10 = 2131,
            STREAMER_PARAMETER_IDS_11 = 2132,
            STREAMER_PARAMETER_IDS_12 = 2133,
            STREAMER_PARAMETER_IDS_13 = 2134,
            STREAMER_PARAMETER_IDS_14 = 2135,
            STREAMER_PARAMETER_IDS_15 = 2136,
            STREAMER_PARAMETER_IDS_16 = 2137,
            STREAMER_PARAMETER_IDS_17 = 2138,
            STREAMER_PARAMETER_IDS_18 = 2139,
            STREAMER_PARAMETER_IDS_19 = 2140,
            STREAMER_PARAMETER_IDS_20 = 2141,
            STREAMER_PARAMETER_IDS_21 = 2142,
            STREAMER_PARAMETER_IDS_22 = 2143,
            STREAMER_PARAMETER_IDS_23 = 2144,
            STREAMER_PARAMETER_IDS_24 = 2145,
            STREAMER_PARAMETER_IDS_25 = 2146,
            STREAMER_PARAMETER_IDS_26 = 2147,
            STREAMER_PARAMETER_IDS_27 = 2148,
            STREAMER_PARAMETER_IDS_28 = 2149,
            STREAMER_PARAMETER_IDS_29 = 2150,
            STREAMER_PARAMETER_IDS_30 = 2151,
            STREAMER_PARAMETER_IDS_31 = 2152,
            STREAMER_PARAMETER_IDS_32 = 2153,
            STREAMER_PARAMETER_IDS_33 = 2154,
            STREAMER_PARAMETER_IDS_34 = 2155,
            STREAMER_PARAMETER_IDS_35 = 2156,
            STREAMER_PARAMETER_IDS_36 = 2157,
            STREAMER_PARAMETER_IDS_37 = 2158,
            STREAMER_PARAMETER_IDS_38 = 2159,
            STREAMER_PARAMETER_IDS_39 = 2160,
            STREAMER_PARAMETER_IDS_40 = 2161,
            STREAMER_PARAMETER_IDS_41 = 2162,
            STREAMER_PARAMETER_IDS_42 = 2163,
            STREAMER_PARAMETER_IDS_43 = 2164,
            STREAMER_PARAMETER_IDS_44 = 2165,
            STREAMER_PARAMETER_IDS_45 = 2166,
            STREAMER_PARAMETER_IDS_46 = 2167,
            STREAMER_PARAMETER_IDS_47 = 2168,
            STREAMER_PARAMETER_IDS_48 = 2169,
            STREAMER_PARAMETER_IDS_49 = 2170,
            STREAMER_PARAMETER_IDS_50 = 2171,
            STREAMER_PARAMETER_IDS_51 = 2172,
            STREAMER_PARAMETER_IDS_52 = 2173,
            STREAMER_PARAMETER_IDS_53 = 2174,
            STREAMER_PARAMETER_IDS_54 = 2175,
            STREAMER_PARAMETER_IDS_55 = 2176,
            STREAMER_PARAMETER_IDS_56 = 2177,
            STREAMER_PARAMETER_IDS_57 = 2178,
            STREAMER_PARAMETER_IDS_58 = 2179,
            STREAMER_PARAMETER_IDS_59 = 2180,
            STREAMER_PARAMETER_IDS_60 = 2181,
            STREAMER_PARAMETER_IDS_61 = 2182,
            STREAMER_PARAMETER_IDS_62 = 2183,
            STREAMER_PARAMETER_IDS_63 = 2184,
            STREAMER_PARAMETER_IDS_64 = 2185,
            STREAMER_PARAMETER_IDS_65 = 2186,
            STREAMER_PARAMETER_IDS_66 = 2187,
            STREAMER_PARAMETER_IDS_67 = 2188,
            STREAMER_PARAMETER_IDS_68 = 2189,
            STREAMER_PARAMETER_IDS_69 = 2190,
            STREAMER_PARAMETER_IDS_70 = 2191,
            STREAMER_PARAMETER_IDS_71 = 2192,
            STREAMER_PARAMETER_IDS_72 = 2193,
            STREAMER_PARAMETER_IDS_73 = 2194,
            STREAMER_PARAMETER_IDS_74 = 2195,
            STREAMER_PARAMETER_IDS_75 = 2196,
            STREAMER_PARAMETER_IDS_76 = 2197,
            STREAMER_PARAMETER_IDS_77 = 2198,
            STREAMER_PARAMETER_IDS_78 = 2199,
            STREAMER_PARAMETER_IDS_79 = 2200,
            STREAMER_PARAMETER_IDS_80 = 2201,
            STREAMER_PARAMETER_IDS_81 = 2202,
            STREAMER_PARAMETER_IDS_82 = 2203,
            STREAMER_PARAMETER_IDS_83 = 2204,
            STREAMER_PARAMETER_IDS_84 = 2205,
            STREAMER_PARAMETER_IDS_85 = 2206,
            STREAMER_PARAMETER_IDS_86 = 2207,
            STREAMER_PARAMETER_IDS_87 = 2208,
            STREAMER_PARAMETER_IDS_88 = 2209,
            STREAMER_PARAMETER_IDS_89 = 2210,
            STREAMER_PARAMETER_IDS_90 = 2211,
            STREAMER_PARAMETER_IDS_91 = 2212,
            STREAMER_PARAMETER_IDS_92 = 2213,
            STREAMER_PARAMETER_IDS_93 = 2214,
            STREAMER_PARAMETER_IDS_94 = 2215,
            STREAMER_PARAMETER_IDS_95 = 2216,
            STREAMER_PARAMETER_IDS_96 = 2217,
            STREAMER_PARAMETER_IDS_97 = 2218,
            STREAMER_PARAMETER_IDS_98 = 2219,
            STREAMER_PARAMETER_IDS_99 = 2220,
            STREAMER_PARAMETER_IDS_100 = 2221,
            STREAMER_PARAMETER_IDS_101 = 2222,
            STREAMER_PARAMETER_IDS_102 = 2223,
            STREAMER_PARAMETER_IDS_103 = 2224,
            STREAMER_PARAMETER_IDS_104 = 2225,
            STREAMER_PARAMETER_IDS_105 = 2226,
            STREAMER_PARAMETER_IDS_106 = 2227,
            STREAMER_PARAMETER_IDS_107 = 2228,
            STREAMER_PARAMETER_IDS_108 = 2229,
            STREAMER_PARAMETER_IDS_109 = 2230,
            STREAMER_PARAMETER_IDS_110 = 2231,
            STREAMER_PARAMETER_IDS_111 = 2232,
            STREAMER_PARAMETER_IDS_112 = 2233,
            STREAMER_PARAMETER_IDS_113 = 2234,
            STREAMER_PARAMETER_IDS_114 = 2235,
            STREAMER_PARAMETER_IDS_115 = 2236,
            STREAMER_PARAMETER_IDS_116 = 2237,
            STREAMER_PARAMETER_IDS_117 = 2238,
            STREAMER_PARAMETER_IDS_118 = 2239,
            STREAMER_PARAMETER_IDS_119 = 2240,
            STREAMER_PARAMETER_IDS_120 = 2241,
            STREAMER_PARAMETER_IDS_121 = 2242,
            STREAMER_PARAMETER_IDS_122 = 2243,
            STREAMER_PARAMETER_IDS_123 = 2244,
            STREAMER_PARAMETER_IDS_124 = 2245,
            STREAMER_PARAMETER_IDS_125 = 2246,
            STREAMER_PARAMETER_IDS_126 = 2247,
            STREAMER_PARAMETER_IDS_127 = 2248,
            STREAMER_PARAMETER_IDS_128 = 2249,
            STREAMER_PARAMETER_IDS_129 = 2250,
            STREAMER_PARAMETER_IDS_130 = 2251,
            STREAMER_PARAMETER_IDS_131 = 2252,
            STREAMER_PARAMETER_IDS_132 = 2253,
            STREAMER_PARAMETER_IDS_133 = 2254,
            STREAMER_PARAMETER_IDS_134 = 2255,
            STREAMER_PARAMETER_IDS_135 = 2256,
            STREAMER_PARAMETER_IDS_136 = 2257,
            STREAMER_PARAMETER_IDS_137 = 2258,
            STREAMER_PARAMETER_IDS_138 = 2259,
            STREAMER_PARAMETER_IDS_139 = 2260,
            STREAMER_PARAMETER_IDS_140 = 2261,
            STREAMER_PARAMETER_IDS_141 = 2262,
            STREAMER_PARAMETER_IDS_142 = 2263,
            STREAMER_PARAMETER_IDS_143 = 2264,
            STREAMER_PARAMETER_IDS_144 = 2265,
            STREAMER_PARAMETER_IDS_145 = 2266,
            STREAMER_PARAMETER_IDS_146 = 2267,
            STREAMER_PARAMETER_IDS_147 = 2268,
            STREAMER_PARAMETER_IDS_148 = 2269,
            STREAMER_PARAMETER_IDS_149 = 2270,
            STREAMER_PARAMETER_IDS_150 = 2271,
            STREAMER_PARAMETER_IDS_151 = 2272,
            STREAMER_PARAMETER_IDS_152 = 2273,
            STREAMER_PARAMETER_IDS_153 = 2274,
            STREAMER_PARAMETER_IDS_154 = 2275,
            STREAMER_PARAMETER_IDS_155 = 2276,
            STREAMER_PARAMETER_IDS_156 = 2277,
            STREAMER_PARAMETER_IDS_157 = 2278,
            STREAMER_PARAMETER_IDS_158 = 2279,
            STREAMER_PARAMETER_IDS_159 = 2280,
            STREAMER_PARAMETER_IDS_160 = 2281,
            STREAMER_PARAMETER_IDS_161 = 2282,
            STREAMER_PARAMETER_IDS_162 = 2283,
            STREAMER_PARAMETER_IDS_163 = 2284,
            STREAMER_PARAMETER_IDS_164 = 2285,
            STREAMER_PARAMETER_IDS_165 = 2286,
            STREAMER_PARAMETER_IDS_166 = 2287,
            STREAMER_PARAMETER_IDS_167 = 2288,
            STREAMER_PARAMETER_IDS_168 = 2289,
            STREAMER_PARAMETER_IDS_169 = 2290,
            STREAMER_PARAMETER_IDS_170 = 2291,
            STREAMER_PARAMETER_IDS_171 = 2292,
            STREAMER_PARAMETER_IDS_172 = 2293,
            STREAMER_PARAMETER_IDS_173 = 2294,
            STREAMER_PARAMETER_IDS_174 = 2295,
            STREAMER_PARAMETER_IDS_175 = 2296,
            STREAMER_PARAMETER_IDS_176 = 2297,
            STREAMER_PARAMETER_IDS_177 = 2298,
            STREAMER_PARAMETER_IDS_178 = 2299,
            STREAMER_PARAMETER_IDS_179 = 2300,
            STREAMER_PARAMETER_IDS_180 = 2301,
            STREAMER_PARAMETER_IDS_181 = 2302,
            STREAMER_PARAMETER_IDS_182 = 2303,
            STREAMER_PARAMETER_IDS_183 = 2304,
            STREAMER_PARAMETER_IDS_184 = 2305,
            STREAMER_PARAMETER_IDS_185 = 2306,
            STREAMER_PARAMETER_IDS_186 = 2307,
            STREAMER_PARAMETER_IDS_187 = 2308,
            STREAMER_PARAMETER_IDS_188 = 2309,
            STREAMER_PARAMETER_IDS_189 = 2310,
            STREAMER_PARAMETER_IDS_190 = 2311,
            STREAMER_PARAMETER_IDS_191 = 2312,
            STREAMER_PARAMETER_IDS_192 = 2313,
            STREAMER_PARAMETER_IDS_193 = 2314,
            STREAMER_PARAMETER_IDS_194 = 2315,
            STREAMER_PARAMETER_IDS_195 = 2316,
            STREAMER_PARAMETER_IDS_196 = 2317,
            STREAMER_PARAMETER_IDS_197 = 2318,
            STREAMER_PARAMETER_IDS_198 = 2319,
            STREAMER_PARAMETER_IDS_199 = 2320,
            STREAMER_INTERVAL_US = 2321,
            STREAMER_FRAME_COUNTER = 2322,
            STREAMER_PARAMETER_QTY = 2323,
            STREAMER_FRAME_GENERATION_EXECUTION_TIME_US = 2324,
            BOARD_STARTUP_DELAY_MS = 2325,
            BOARD_STARTUP_RETRY_QTY = 2326,
            BOARD_STARTUP_RETRY_DELAY_MS = 2327,
            BOARD_STARTUP_REPORT_OVERALL_RESULT = 2328,
            BOARD_STARTUP_REPORT_EXECUTION_TIME_US = 2329,
            BOARD_STARTUP_REPORT_WIZ850IO_CONNECTION_RESULT = 2330,
            BOARD_STARTUP_REPORT_WIZ850IO_CONNECTION_RETRY = 2331,
            BOARD_STARTUP_REPORT_WIZ850IO_CONNECTION_TIME_US = 2332,
            BOARD_STARTUP_REPORT_WIZ850IO_CONFIG_RESULT = 2333,
            BOARD_STARTUP_REPORT_WIZ850IO_CONFIG_RETRY = 2334,
            BOARD_STARTUP_REPORT_WIZ850IO_CONFIG_TIME_US = 2335,
            NONE = 65535
        }
        ...
        public enum eParameterMbAddr : ushort
        {
            ...
            PARAMETER_MB_ADDR_DOWN_STREAM_STATISTICS_0_RECEIVED_FRAME_QTY_0 = 4074,
            PARAMETER_MB_ADDR_DOWN_STREAM_STATISTICS_0_RECEIVED_FRAME_QTY_1 = 4075,
            PARAMETER_MB_ADDR_DOWN_STREAM_STATISTICS_0_SEND_FRAME_QTY_0 = 4076,
            PARAMETER_MB_ADDR_DOWN_STREAM_STATISTICS_0_SEND_FRAME_QTY_1 = 4077,
            PARAMETER_MB_ADDR_DOWN_STREAM_STATISTICS_0