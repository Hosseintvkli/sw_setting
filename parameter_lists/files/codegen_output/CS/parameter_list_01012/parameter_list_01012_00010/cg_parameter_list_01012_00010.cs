...
namespace ACCUNAV_IMU_Setting
{
    ...
    public class Parameters_DeviceID_01012_00010 : IParameterListDevice
    {
        ...
        public UInt16 eraseAllLogs;
        public UInt32 recordMemoryStartAddress;
        public UInt32 recordMemorySize;
        public UInt32 payloadMemoryStartAddress;
        public UInt32 payloadMemorySize;

        public Parameters_DeviceID_01012_00010()
        {
            readedOnce = false;
            ...
            eraseAllLogs = 0;
            recordMemoryStartAddress = 0;
            recordMemorySize = 2000;
            payloadMemoryStartAddress = 2000;
            payloadMemorySize = 4000;
        }
        ...
        [Category("RappLogger"), ReadOnly(false), DefaultValue(0), Description("")]
        public UInt16 EraseAllLogs
        {
            get { return eraseAllLogs; }
            set
            {
                if(MainForm.modbusExt.ModbusWrite(5611, 0, value, typeof(UInt16), 1))
                {
                    eraseAllLogs = value;
                }
            }
        ...
        public UInt32 RecordMemoryStartAddress
        {
            get { return recordMemoryStartAddress; }
            set
            {
                if(MainForm.modbusExt.ModbusWrite(5612, 0, value, typeof(UInt32), 1))
                {
                    recordMemoryStartAddress = value;
                }
            }
        }

        [Category("RappLogger"), ReadOnly(false), DefaultValue(2000), Description("")]
        public UInt32 RecordMemorySize
        {
            get { return recordMemorySize; }
            set
            {
                if(MainForm.modbusExt.ModbusWrite(5614, 0, value, typeof(UInt32), 1))
                {
                    recordMemorySize = value;
                }
            }
        }
        ...
        public UInt32 PayloadMemoryStartAddress
        {
            get { return payloadMemoryStartAddress; }
            set
            {
                if(MainForm.modbusExt.ModbusWrite(5616, 0, value, typeof(UInt32), 1))
                {
                    payloadMemoryStartAddress = value;
                }
            }
        }

        [Category("RappLogger"), ReadOnly(false), DefaultValue(4000), Description("")]
        public UInt32 PayloadMemorySize
        {
            get { return payloadMemorySize; }
            set
            {
                if(MainForm.modbusExt.ModbusWrite(5618, 0, value, typeof(UInt32), 1))
                {
                    payloadMemorySize = value;
                }
            }
        }
        ...
        public bool ModbusWriteAll()
        {
            ...
            _status &= MainForm.modbusExt.ModbusWrite(5611, 0, eraseAllLogs, typeof(UInt16), 1);
            _status &= MainForm.modbusExt.ModbusWrite(5612, 0, recordMemoryStartAddress, typeof(UInt32), 1);
            _status &= MainForm.modbusExt.ModbusWrite(5614, 0, recordMemorySize, typeof(UInt32), 1);
            _status &= MainForm.modbusExt.ModbusWrite(5616, 0, payloadMemoryStartAddress, typeof(UInt32), 1);
            _status &= MainForm.modbusExt.ModbusWrite(5618, 0, payloadMemorySize, typeof(UInt32), 1);
        ...
        public void ModbusReadAll()
        {
            if (readedOnce){return;} else
            {
                ...
                eraseAllLogs = MainForm.modbusExt.ModbusRead(5611, 0, typeof(UInt16), 1);
                recordMemoryStartAddress = MainForm.modbusExt.ModbusRead(5612, 0, typeof(UInt32), 1);
                recordMemorySize = MainForm.modbusExt.ModbusRead(5614, 0, typeof(UInt32), 1);
                payloadMemoryStartAddress = MainForm.modbusExt.ModbusRead(5616, 0, typeof(UInt32), 1);
                payloadMemorySize = MainForm.modbusExt.ModbusRead(5618, 0, typeof(UInt32), 1);
        ...
        public void SessionStart_Button_Click(object sender, EventArgs e)
        {
            // Handle the button click
            MainForm.modbusExt.SetWaitCursor(true);
        
            MainForm.modbusExt.ModbusWrite(5607, 0, (ushort)0xFFFF, typeof(UInt16), 1);
        
            byte cnt = 0;
            while (true)
            {
                ushort result = MainForm.modbusExt.ModbusRead(5607, 0, typeof(UInt16), 1);
        ...
        public void SessionStop_Button_Click(object sender, EventArgs e)
        {
            // Handle the button click
            MainForm.modbusExt.SetWaitCursor(true);
        
            MainForm.modbusExt.ModbusWrite(5608, 0, (ushort)0xFFFF, typeof(UInt16), 1);
        
            byte cnt = 0;
            while (true)
            {
                ushort result = MainForm.modbusExt.ModbusRead(5608, 0, typeof(UInt16), 1);
        ...
        public void SendLogStart_Button_Click(object sender, EventArgs e)
        {
            ...
            MainForm.modbusExt.ModbusWrite(5609, 0, (ushort)0xFFFF, typeof(UInt16), 1);
        
            byte cnt = 0;
            while (true)
            {
                ushort result = MainForm.modbusExt.ModbusRead(5609, 0, typeof(UInt16), 1);
        ...
        public void SendLogStop_Button_Click(object sender, EventArgs e)
        {
            ...
            MainForm.modbusExt.ModbusWrite(5610, 0, (ushort)0xFFFF, typeof(UInt16), 1);
        
            byte cnt = 0;
            while (true)
            {
                ushort result = MainForm.modbusExt.ModbusRead(5610, 0, typeof(UInt16), 1);
        ...
        public enum eParameterId : ushort
        {
            ...
            SEND_LOG_STOP = 2828,
            ERASE_ALL_LOGS = 2829,
            RECORD_MEMORY_START_ADDRESS = 2830,
            RECORD_MEMORY_SIZE = 2831,
            PAYLOAD_MEMORY_START_ADDRESS = 2832,
            PAYLOAD_MEMORY_SIZE = 2833,
            SESSIONS_QTY = 2834,
            RECORDS_QTY = 2835,
            REMAIN_RECORDS_QTY = 2836,
            NONE = 65535
        }
        ...
        public enum eParameterMbAddr : ushort
        {
            ...
            PARAMETER_MB_ADDR_M9N_DATA_RESESRVED_0 = 4563,
            PARAMETER_MB_ADDR_M9N_DATA_RESESRVED_1 = 4564,
            PARAMETER_MB_ADDR_M9N_DATA_RESESRVED_2 = 4565,
            PARAMETER_MB_ADDR_M9N_DATA_RESESRVED_3 = 4566,
            ...
            PARAMETER_MB_ADDR_SESSION_START = 5607,
            PARAMETER_MB_ADDR_SESSION_STOP = 5608,
            PARAMETER_MB_ADDR_SEND_LOG_START = 5609,
            PARAMETER_MB_ADDR_SEND_LOG_STOP = 5610,
            PARAMETER_MB_ADDR_ERASE_ALL_LOGS = 5611,
            PARAMETER_MB_ADDR_RECORD_MEMORY_START_ADDRESS_0 = 5612,
            PARAMETER_MB_ADDR_RECORD_MEMORY_START_ADDRESS_1 = 5613,
            PARAMETER_MB_ADDR_RECORD_MEMORY_SIZE_0 = 5614,
            PARAMETER_MB_ADDR_RECORD_MEMORY_SIZE_1 = 5615,
            PARAMETER_MB_ADDR_PAYLOAD_MEMORY_START_ADDRESS_0 = 5616,
            PARAMETER_MB_ADDR_PAYLOAD_MEMORY_START_ADDRESS_1 = 5617,
            PARAMETER_MB_ADDR_PAYLOAD_MEMORY_SIZE_0 = 5618,
            PARAMETER_MB_ADDR_PAYLOAD_MEMORY_SIZE_1 = 5619,
            PARAMETER_MB_ADDR_SESSIONS_QTY_0 = 5620,
            PARAMETER_MB_ADDR_SESSIONS_QTY_1 = 5621,
            PARAMETER_MB_ADDR_RECORDS_QTY_0 = 5622,
            PARAMETER_MB_ADDR_RECORDS_QTY_1 = 5623,
            PARAMETER_MB_ADDR_REMAIN_RECORDS_QTY_0 = 5624,
            PARAMETER_MB_ADDR_REMAIN_RECORDS_QTY_1 = 5625
        }
    }
}
