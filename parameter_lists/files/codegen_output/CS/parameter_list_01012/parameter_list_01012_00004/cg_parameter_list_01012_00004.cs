...
namespace ACCUNAV_IMU_Setting
{
    ...
    public class Parameters_DeviceID_01012_00004 : IParameterListDevice
    {
        ...
        public Parameters_DeviceID_01012_00004()
        {
            readedOnce = false;
        ...
        public enum eParameterMbAddr : ushort
        {
            ...
            PARAMETER_MB_ADDR_SESSION_QTY = 5610,
            PARAMETER_MB_ADDR_RECORD_QTY = 5611
        }
    }
}
