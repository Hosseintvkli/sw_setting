...
namespace ACCUNAV_IMU_Setting
{
    ...
    public class Parameters_DeviceID_01012_00008 : IParameterListDevice
    {
        ...
        public UInt16 sessionStart;
        public UInt16 sessionStop;
        public UInt16 sendLogEnable;
        ...
        public Parameters_DeviceID_01012_00008()
        {
            readedOnce = false;
        ...
        public UInt16 SessionStart
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(5607, 0, value, typeof(UInt16), 1))
                {
                    sessionStart = value;
                }
            }
        ...
        public UInt16 SessionStop
        {
            get { return sessionStop; }
            set
            {
                if(MainForm.modbusExt.ModbusWrite(5608, 0, value, typeof(UInt16), 1))
                {
                    sessionStop = value;
                }
            }
        ...
        public UInt16 SendLogEnable
        {
            get { return sendLogEnable; }
            set
            {
                if(MainForm.modbusExt.ModbusWrite(5609, 0, value, typeof(UInt16), 1))
                {
                    sendLogEnable = value;
                }
            }
        ...
        public UInt16 EraseAllLogs
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(5610, 0, value, typeof(UInt16), 1))
                {
                    eraseAllLogs = value;
                }
            }
        ...
        public UInt32 RecordMemoryStartAddress
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(5611, 0, value, typeof(UInt32), 1))
                {
        ...
        public UInt32 RecordMemorySize
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(5613, 0, value, typeof(UInt32), 1))
                {
        ...
        public UInt32 PayloadMemoryStartAddress
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(5615, 0, value, typeof(UInt32), 1))
                {
        ...
        public UInt32 PayloadMemorySize
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(5617, 0, value, typeof(UInt32), 1))
                {
        ...
        public bool ModbusWriteAll()
        {
            ...
            _status &= MainForm.modbusExt.ModbusWrite(5607, 0, sessionStart, typeof(UInt16), 1);
            _status &= MainForm.modbusExt.ModbusWrite(5608, 0, sessionStop, typeof(UInt16), 1);
            _status &= MainForm.modbusExt.ModbusWrite(5609, 0, sendLogEnable, typeof(UInt16), 1);
            _status &= MainForm.modbusExt.ModbusWrite(5610, 0, eraseAllLogs, typeof(UInt16), 1);
            _status &= MainForm.modbusExt.ModbusWrite(5611, 0, recordMemoryStartAddress, typeof(UInt32), 1);
            _status &= MainForm.modbusExt.ModbusWrite(5613, 0, recordMemorySize, typeof(UInt32), 1);
            _status &= MainForm.modbusExt.ModbusWrite(5615, 0, payloadMemoryStartAddress, typeof(UInt32), 1);
            _status &= MainForm.modbusExt.ModbusWrite(5617, 0, payloadMemorySize, typeof(UInt32), 1);
        ...
        public void ModbusReadAll()
        {
            if (readedOnce){return;} else
            {
                ...
                sessionStart = MainForm.modbusExt.ModbusRead(5607, 0, typeof(UInt16), 1);
                sessionStop = MainForm.modbusExt.ModbusRead(5608, 0, typeof(UInt16), 1);
                sendLogEnable = MainForm.modbusExt.ModbusRead(5609, 0, typeof(UInt16), 1);
                eraseAllLogs = MainForm.modbusExt.ModbusRead(5610, 0, typeof(UInt16), 1);
                recordMemoryStartAddress = MainForm.modbusExt.ModbusRead(5611, 0, typeof(UInt32), 1);
                recordMemorySize = MainForm.modbusExt.ModbusRead(5613, 0, typeof(UInt32), 1);
                payloadMemoryStartAddress = MainForm.modbusExt.ModbusRead(5615, 0, typeof(UInt32), 1);
                payloadMemorySize = MainForm.modbusExt.ModbusRead(5617, 0, typeof(UInt32), 1);
        ...
        public enum eParameterId : ushort
        {
            ...
            SESSION_START = 2825,
            SESSION_STOP = 2826,
            SEND_LOG_ENABLE = 2827,
            ERASE_ALL_LOGS = 2828,
            RECORD_MEMORY_START_ADDRESS = 2829,
            RECORD_MEMORY_SIZE = 2830,
            PAYLOAD_MEMORY_START_ADDRESS = 2831,
            PAYLOAD_MEMORY_SIZE = 2832,
            SESSION_QTY = 2833,
            RECORD_QTY = 2834,
            NONE = 65535
        }
        ...
        public enum eParameterMbAddr : ushort
        {
            ...
            PARAMETER_MB_ADDR_SEND_LOG_ENABLE = 5609,
            PARAMETER_MB_ADDR_ERASE_ALL_LOGS = 5610,
            PARAMETER_MB_ADDR_RECORD_MEMORY_START_ADDRESS_0 = 5611,
            PARAMETER_MB_ADDR_RECORD_MEMORY_START_ADDRESS_1 = 5612,
            PARAMETER_MB_ADDR_RECORD_MEMORY_SIZE_0 = 5613,
            PARAMETER_MB_ADDR_RECORD_MEMORY_SIZE_1 = 5614,
            PARAMETER_MB_ADDR_PAYLOAD_MEMORY_START_ADDRESS_0 = 5615,
            PARAMETER_MB_ADDR_PAYLOAD_MEMORY_START_ADDRESS_1 = 5616,
            PARAMETER_MB_ADDR_PAYLOAD_MEMORY_SIZE_0 = 5617,
            PARAMETER_MB_ADDR_PAYLOAD_MEMORY_SIZE_1 = 5618,
            PARAMETER_MB_ADDR_SESSION_QTY_0 = 5619,
            PARAMETER_MB_ADDR_SESSION_QTY_1 = 5620,
            PARAMETER_MB_ADDR_RECORD_QTY_0 = 5621,
            PARAMETER_MB_ADDR_RECORD_QTY_1 = 5622
        }
    }
}
