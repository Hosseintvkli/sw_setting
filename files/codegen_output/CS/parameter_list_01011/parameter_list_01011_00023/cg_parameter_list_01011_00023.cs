...
namespace ACCUNAV_IMU_Setting
{
    ...
    public class Parameters_DeviceID_01011_00023 : IParameterListDevice
    {
        ...
        public Parameters_DeviceID_01011_00023()
        {
            readedOnce = false;
        ...
        public Double CalcPreProcessAlgorithm_AccI32_Range
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(6851, 0, value, typeof(Double), 1))
                {
        ...
        public Double CalcPreProcessAlgorithm_GyroI32_Range
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(6855, 0, value, typeof(Double), 1))
                {
        ...
        public bool ModbusWriteAll()
        {
            ...
            _status &= MainForm.modbusExt.ModbusWrite(6851, 0, calcPreProcessAlgorithm_AccI32_Range, typeof(Double), 1);
            _status &= MainForm.modbusExt.ModbusWrite(6855, 0, calcPreProcessAlgorithm_GyroI32_Range, typeof(Double), 1);
        ...
        public void ModbusReadAll()
        {
            if (readedOnce){return;} else
            {
                ...
                calcPreProcessAlgorithm_AccI32_Range = MainForm.modbusExt.ModbusRead(6851, 0, typeof(Double), 1);
                calcPreProcessAlgorithm_GyroI32_Range = MainForm.modbusExt.ModbusRead(6855, 0, typeof(Double), 1);
        ...
        public enum eParameterId : ushort
        {
            ...
            CALC_PRE_PROCESS_ALGORITHM_ACC_0_X = 3458,
            CALC_PRE_PROCESS_ALGORITHM_ACC_0_Y = 3459,
            CALC_PRE_PROCESS_ALGORITHM_ACC_0_Z = 3460,
            CALC_PRE_PROCESS_ALGORITHM_ACC_1_X = 3461,
            CALC_PRE_PROCESS_ALGORITHM_ACC_1_Y = 3462,
            CALC_PRE_PROCESS_ALGORITHM_ACC_1_Z = 3463,
            CALC_PRE_PROCESS_ALGORITHM_GYRO_0_X = 3464,
            CALC_PRE_PROCESS_ALGORITHM_GYRO_0_Y = 3465,
            CALC_PRE_PROCESS_ALGORITHM_GYRO_0_Z = 3466,
            CALC_PRE_PROCESS_ALGORITHM_GYRO_1_X = 3467,
            CALC_PRE_PROCESS_ALGORITHM_GYRO_1_Y = 3468,
            CALC_PRE_PROCESS_ALGORITHM_GYRO_1_Z = 3469,
            CALC_PRE_PROCESS_ALGORITHM_ACC_I32_0_X = 3470,
            CALC_PRE_PROCESS_ALGORITHM_ACC_I32_0_Y = 3471,
            CALC_PRE_PROCESS_ALGORITHM_ACC_I32_0_Z = 3472,
            CALC_PRE_PROCESS_ALGORITHM_ACC_I32_1_X = 3473,
            CALC_PRE_PROCESS_ALGORITHM_ACC_I32_1_Y = 3474,
            CALC_PRE_PROCESS_ALGORITHM_ACC_I32_1_Z = 3475,
            CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_0_X = 3476,
            CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_0_Y = 3477,
            CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_0_Z = 3478,
            CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_1_X = 3479,
            CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_1_Y = 3480,
            CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_1_Z = 3481,
            CALC_PRE_PROCESS_ALGORITHM_ACC_I32_RANGE = 3482,
            CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_RANGE = 3483,
            CALC_PRE_PROCESS_ALGORITHM_VERSION_MAJOR = 3484,
            CALC_PRE_PROCESS_ALGORITHM_VERSION_MINOR = 3485,
            CALC_PRE_PROCESS_ALGORITHM_VERSION_BUILD1 = 3486,
            CALC_PRE_PROCESS_ALGORITHM_VERSION_BUILD2 = 3487,
            GENERAL_STATUS_SUMMARY = 3488,
            NONE = 65535
        }
        ...
        public enum eParameterMbAddr : ushort
        {
            ...
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_0_X_0 = 6779,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_0_X_1 = 6780,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_0_X_2 = 6781,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_0_X_3 = 6782,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_0_Y_0 = 6783,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_0_Y_1 = 6784,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_0_Y_2 = 6785,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_0_Y_3 = 6786,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_0_Z_0 = 6787,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_0_Z_1 = 6788,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_0_Z_2 = 6789,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_0_Z_3 = 6790,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_1_X_0 = 6791,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_1_X_1 = 6792,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_1_X_2 = 6793,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_1_X_3 = 6794,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_1_Y_0 = 6795,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_1_Y_1 = 6796,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_1_Y_2 = 6797,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_1_Y_3 = 6798,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_1_Z_0 = 6799,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_1_Z_1 = 6800,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_1_Z_2 = 6801,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_1_Z_3 = 6802,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_0_X_0 = 6803,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_0_X_1 = 6804,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_0_X_2 = 6805,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_0_X_3 = 6806,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_0_Y_0 = 6807,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_0_Y_1 = 6808,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_0_Y_2 = 6809,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_0_Y_3 = 6810,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_0_Z_0 = 6811,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_0_Z_1 = 6812,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_0_Z_2 = 6813,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_0_Z_3 = 6814,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_1_X_0 = 6815,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_1_X_1 = 6816,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_1_X_2 = 6817,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_1_X_3 = 6818,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_1_Y_0 = 6819,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_1_Y_1 = 6820,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_1_Y_2 = 6821,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_1_Y_3 = 6822,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_1_Z_0 = 6823,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_1_Z_1 = 6824,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_1_Z_2 = 6825,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_1_Z_3 = 6826,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_0_X_0 = 6827,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_0_X_1 = 6828,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_0_Y_0 = 6829,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_0_Y_1 = 6830,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_0_Z_0 = 6831,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_0_Z_1 = 6832,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_1_X_0 = 6833,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_1_X_1 = 6834,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_1_Y_0 = 6835,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_1_Y_1 = 6836,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_1_Z_0 = 6837,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_1_Z_1 = 6838,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_0_X_0 = 6839,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_0_X_1 = 6840,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_0_Y_0 = 6841,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_0_Y_1 = 6842,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_0_Z_0 = 6843,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_0_Z_1 = 6844,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_1_X_0 = 6845,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_1_X_1 = 6846,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_1_Y_0 = 6847,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_1_Y_1 = 6848,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_1_Z_0 = 6849,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_1_Z_1 = 6850,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_RANGE_0 = 6851,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_RANGE_1 = 6852,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_RANGE_2 = 6853,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_ACC_I32_RANGE_3 = 6854,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_RANGE_0 = 6855,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_RANGE_1 = 6856,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_RANGE_2 = 6857,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_GYRO_I32_RANGE_3 = 6858,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_VERSION_MAJOR = 6859,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_VERSION_MINOR = 6860,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_VERSION_BUILD1 = 6861,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_VERSION_BUILD2_0 = 6862,
            PARAMETER_MB_ADDR_CALC_PRE_PROCESS_ALGORITHM_VERSION_BUILD2_1 = 6863,
            PARAMETER_MB_ADDR_GENERAL_STATUS_SUMMARY_0 = 6864,
            PARAMETER_MB_ADDR_GENERAL_STATUS_SUMMARY_1 = 6865
        }
    }
}
