...
namespace ACCUNAV_IMU_Setting
{
    ...
    public class Parameters_DeviceID_01012_00005 : IParameterListDevice
    {
        ...
        public Parameters_DeviceID_01012_00005()
        {
            readedOnce = false;
        ...
        public enum eParameterMbAddr : ushort
        {
            ...
            PARAMETER_MB_ADDR_SESSION_QTY_0 = 5610,
            PARAMETER_MB_ADDR_SESSION_QTY_1 = 5611,
            PARAMETER_MB_ADDR_RECORD_QTY_0 = 5612,
            PARAMETER_MB_ADDR_RECORD_QTY_1 = 5613
        }
    }
}
