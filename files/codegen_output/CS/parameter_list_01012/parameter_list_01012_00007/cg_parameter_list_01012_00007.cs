...
namespace ACCUNAV_IMU_Setting
{
    ...
    public class Parameters_DeviceID_01012_00007 : IParameterListDevice
    {
        ...
        public Parameters_DeviceID_01012_00007()
        {
            readedOnce = false;
        ...
        public UInt32 RecordMemoryStartAddress
        {
            ...
            set
            {
                if(MainForm.modbusExt.ModbusWrite(5610, 0, value, typeof(UInt32), 1))
                {
        ...
        public bool ModbusWriteAll()
        {
            ...
            _status &= MainForm.modbusExt.ModbusWrite(5610, 0, recordMemoryStartAddress, typeof(UInt32), 1);
            _status &= MainForm.modbusExt.ModbusWrite(5612, 0, recordMemorySize, typeof(UInt32), 1);
            _status &= MainForm.modbusExt.ModbusWrite(5614, 0, payloadMemoryStartAddress, typeof(UInt32), 1);
            _status &= MainForm.modbusExt.ModbusWrite(5616, 0, payloadMemorySize, typeof(UInt32), 1);
        ...
        public void ModbusReadAll()
        {
            if (readedOnce){return;} else
            {
                ...
                recordMemoryStartAddress = MainForm.modbusExt.ModbusRead(5610, 0, typeof(UInt32), 1);
                recordMemorySize = MainForm.modbusExt.ModbusRead(5612, 0, typeof(UInt32), 1);
                payloadMemoryStartAddress = MainForm.modbusExt.ModbusRead(5614, 0, typeof(UInt32), 1);
                payloadMemorySize = MainForm.modbusExt.ModbusRead(5616, 0, typeof(UInt32), 1);
        ...
        public enum eParameterId : ushort
        {
            ...
            RECORD_MEMORY_START_ADDRESS = 2828,
            RECORD_MEMORY_SIZE = 2829,
            PAYLOAD_MEMORY_START_ADDRESS = 2830,
            PAYLOAD_MEMORY_SIZE = 2831,
            SESSION_QTY = 2832,
            RECORD_QTY = 2833,
            NONE = 65535
        }
        ...
        public enum eParameterMbAddr : ushort
        {
            ...
            PARAMETER_MB_ADDR_RECORD_MEMORY_START_ADDRESS_0 = 5610,
            PARAMETER_MB_ADDR_RECORD_MEMORY_START_ADDRESS_1 = 5611,
            PARAMETER_MB_ADDR_RECORD_MEMORY_SIZE_0 = 5612,
            PARAMETER_MB_ADDR_RECORD_MEMORY_SIZE_1 = 5613,
            PARAMETER_MB_ADDR_PAYLOAD_MEMORY_START_ADDRESS_0 = 5614,
            PARAMETER_MB_ADDR_PAYLOAD_MEMORY_START_ADDRESS_1 = 5615,
            PARAMETER_MB_ADDR_PAYLOAD_MEMORY_SIZE_0 = 5616,
            PARAMETER_MB_ADDR_PAYLOAD_MEMORY_SIZE_1 = 5617,
            PARAMETER_MB_ADDR_SESSION_QTY_0 = 5618,
            PARAMETER_MB_ADDR_SESSION_QTY_1 = 5619,
            PARAMETER_MB_ADDR_RECORD_QTY_0 = 5620,
            PARAMETER_MB_ADDR_RECORD_QTY_1 = 5621
        }
    }
}
